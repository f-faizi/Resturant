  ...
  return (
   <div className='container mx-auto flex flex-col items-center justify-center h-screen'>
      <div className="flex flex-col items-center justify-center lg:w-[40%]  md:w-[50%] w-[90%]">
        <h3 className='h3'>Please Sign In here</h3>
      ...
      <div className='flex flex-col items-center justify-center'>
            <button className='bg-blue-950 text-white lg:px-[180px] md:px-[150px] px-[180px] py-1 mb-4 my-8 hover:bg-blue-700 hover:px-[190px] scroll-smooth duration-300'>Sign In</button>
      </div>
    </div>
  )
}
